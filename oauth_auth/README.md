...
Этот проект является **учебным примером** для демонстрации технологий OAuth 2.0, FastAPI и современной веб-разработки. 

### 🎓 Образовательные цели:
- Изучение OAuth 2.0 flow с внешними провайдерами
- Практика работы с FastAPI и асинхронным программированием
- Понимание JWT токенов и безопасности веб-приложений
- Интеграция с внешними API (Яндекс OAuth)

### ⚠️ Важные замечания:
- **Не используйте в продакшене** без дополнительной настройки безопасности
- **Смените все секретные ключи** перед развертыванием
- **Добавьте HTTPS** для реального использования
- **Настройте мониторинг** и логирование

### 📚 Свободное использование:
Вы можете свободно использовать этот код для:
- ✅ Обучения и изучения технологий
- ✅ Создания собственных проектов на основе примера
- ✅ Модификации и адаптации под свои нужды
- ✅ Использования в учебных курсах и презентациях

**Удачи в изучении современных веб-технологий!** 🚀
...
**🎓 Учебный проект для демонстрации OAuth 2.0, FastAPI и современной веб-разработки**

*Создано с ❤️ для изучения технологий*