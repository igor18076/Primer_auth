...
│   ├── main.py           # FastAPI приложение с Яндекс OAuth
│   ├── requirements.txt  # Зависимости
│   ├── README.md         # Подробная документация
...
### 3. OAuth 2.0 аутентификация (FastAPI + Яндекс)
...
source venv/bin/activate
pip install -r requirements.txt
# Настройте Яндекс OAuth 2.0 (см. SETUP.md)
python main.py
# Откройте http://localhost:8000
```
...
| **Зависимости** | Redis | Нет | Внешний провайдер (Яндекс) |
...
### OAuth 2.0
```bash
# Профиль (после OAuth flow с Яндекс)
curl http://localhost:8000/profile \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
...
### OAuth 2.0:
- Настройте правильные redirect URIs для Яндекса
- Используйте HTTPS для callback URL
- Реализуйте обработку ошибок от провайдера
- Рассмотрите добавление других провайдеров (VK, Mail.ru)

## 📚 Дополнительные ресурсы

- [OWASP Authentication Cheat Sheet](https://cheatsheetseries.owasp.org/cheatsheets/Authentication_Cheat_Sheet.html)
- [JWT.io](https://jwt.io/) - отладка JWT токенов
- [Яндекс OAuth 2.0](https://yandex.ru/dev/id/doc/ru/concepts/ya-oauth-intro) - документация Яндекса
